...
%                     To set the key, use:
%                     google_map('APIKey','SomeLongStringObtaindFromGoogle')
...
%
% Acknowledgements:
%  Val Schmidt, Abe for his submission of get_google_map.m
%
% @Author:
%  Lichang Xu
